...
14. **El campo del buscador no tiene ni una excepción** respecto de un campo de la columna derecha: mismo fondo, borde, alto, radio y foco. Marcarle más el borde para despegarlo de `chrome` —que está a un 5 % de su claridad— lo dejaba pareciéndose a sí mismo y a nada más.
