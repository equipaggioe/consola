# Capturas — lo que entrega no es un log ni una URL, es un archivo publicable

Cómo se generan capturas de pantalla de las apps de un repo, con datos ficticios, listas para
publicar. Continúa [launchers.md](launchers.md) (de ahí salen las apps vivas que se fotografían)
y [atomicas.md](atomicas.md) (§0, qué **no** es una atómica).

Estado: propuesta. Nada de esto está construido todavía.
...
[atomicas.md](atomicas.md): cada una tiene sentido re-ejecutarla sola.
...
([panel-de-parametros.md](panel-de-parametros.md)).
